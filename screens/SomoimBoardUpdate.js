...
class SomoimBoardUpdate extends Component {
    state = {
        somoimBoardCategory: this.props.route.params.post.category,
        title: this.props.route.params.post.title,
        content: this.props.route.params.post.content,
        modal: false,
    ...
    componentDidMount(){
        ...
        if(this.props.route.params.post.photoUris.length === 3){
            this.setState({imageUris: this.props.route.params.post.photoUris})
        }else if(this.props.route.params.post.photoUris.length === 2){
            this.setState({imageUris: [...this.props.route.params.post.photoUris, null]})
        }else if(this.props.route.params.post.photoUris.length === 1){
            this.setState({imageUris: [...this.props.route.params.post.photoUris, null, null]})
        }
    }
    onComplete = () => {
        ...
        if(title === '' || content === ''){
            ...
            this.setState({indicator: true}, () => {
                ...
                db.doc(`somoim/${this.props.route.params.post.somoimDocId}/board/${this.props.route.params.post.postDocId}`).update({
                ...
                .then(async () => {
                    const photoUris = [...this.props.route.params.post.photoUris];

                    const promises = this.state.imageUris.map(async(uri, index) => {
                        if(uri !== this.props.route.params.post.photoUris[index]){
                            if(this.props.route.params.post.photoUris[index] !== null){
                                const ref = fbStorage.ref().child(`somoim/${this.props.route.params.post.somoimDocId}/board/${this.props.route.params.post.postDocId}/${index}.png`);
                                await ref.delete();
                            }
                            if(uri !== null){
                                const response = await fetch(uri);
                                const blob = await response.blob();
                                const uploadTask = await fbStorage.ref().child(`somoim/${this.props.route.params.post.somoimDocId}/board/${this.props.route.params.post.postDocId}/${index}.png`).put(blob, {
                    ...
                    await db.doc(`somoim/${this.props.route.params.post.somoimDocId}/board/${this.props.route.params.post.postDocId}`).update({
                        photoUris: photoUris
                    })
...
export default SomoimBoardUpdate;